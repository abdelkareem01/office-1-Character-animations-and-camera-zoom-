...
public class FirstPersonAIO : MonoBehaviour {
    ...
    private void Update(){
        ...
        {
            if (playerCamera.fieldOfView<=125)
                playerCamera.fieldOfView +=2;
            if (playerCamera.orthographicSize<=20)
    ...
    // ---------------Code for Zooming In------------------------
     if (Input.GetAxis("Mouse ScrollWheel") > 0)
        {
            if (playerCamera.fieldOfView>2)
                playerCamera.fieldOfView -=2;
            if (playerCamera.orthographicSize>=1)
                                playerCamera.orthographicSize -=1;
        }
    ...
    {
        if (playerCamera.orthographic==true)
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Camera Setup
            ...
            t.thirdPerson = (Camera)EditorGUILayout.ObjectField(new GUIContent("Player Camera", "Camera attached to this controller"),t.thirdPerson,typeof(Camera),true);
            ...
            GUI.enabled = true;
            EditorGUILayout.Space();
            t.anim = (Animator)EditorGUILayout.ObjectField(new GUIContent("Player Animator", "Animator attached to this controller"),t.anim,typeof(Animator),true);
        #endregion
